...
class TestSchemaIdentificationService(TransactionTestCase):
    ...
    @staticmethod
    def expected_strava_instances2():
        return [
            'achievement_count - IntAttribute : 0', 'achievement_count - IntAttribute : 11', 'activities - Node',
            'activities__to__athlete - Edge', 'activities__to__end_latlng - Edge',
            'activities__to__gear_id - Edge', 'activities__to__location_city - Edge',
            'activities__to__location_state - Edge', 'activities__to__map - Edge',
            'activities__to__start_latlng - Edge', 'athlete - Node', 'athlete_count - IntAttribute : 1',
            ...
            'commute - BoolAttribute : False', 'display_hide_heartrate_option - BoolAttribute : False',
            ...
            'external_id - StringAttribute : dffe18b96bfe979f96633d7a21930813', 'flagged - BoolAttribute : False',
            'from_accepted_tag - BoolAttribute : False', 'gear_id - Node', 'has_heartrate - BoolAttribute : False',
            'has_kudoed - BoolAttribute : False', 'heartrate_opt_out - BoolAttribute : False',
            'id - IntAttribute : 1853632245', 'id - IntAttribute : 1853676308', 'id - IntAttribute : 1862269980',
            'id - IntAttribute : 1866238587', 'id - IntAttribute : 1870572749', 'id - IntAttribute : 1874410370',
            'id - IntAttribute : 1879752969', 'id - IntAttribute : 465645', 'id - StringAttribute : a1853632245',
            'id - StringAttribute : a1853676308', 'id - StringAttribute : a1862269980',
            'id - StringAttribute : a1866238587', 'id - StringAttribute : a1870572749',
            'id - StringAttribute : a1874410370', 'id - StringAttribute : a1879752969',
            'kudos_count - IntAttribute : 0', 'kudos_count - IntAttribute : 1', 'kudos_count - IntAttribute : 2',
            'location_city - Node', 'location_country - StringAttribute : Denmark', 'location_state - Node',
            'manual - BoolAttribute : False', 'map - Node', 'max_speed - FloatAttribute : 10.7',
            'max_speed - FloatAttribute : 11.3', 'max_speed - FloatAttribute : 14.0',
            'max_speed - FloatAttribute : 4.0', 'max_speed - FloatAttribute : 5.6',
            'max_speed - FloatAttribute : 9.0', 'max_speed - FloatAttribute : 9.4',
            'moving_time - IntAttribute : 1143', 'moving_time - IntAttribute : 1154',
            'moving_time - IntAttribute : 1195', 'moving_time - IntAttribute : 1406',
            'moving_time - IntAttribute : 1514', 'moving_time - IntAttribute : 2283',
            'moving_time - IntAttribute : 777', 'name - StringAttribute : 8 x ~30 sek interval med bakke',
            'name - StringAttribute : 8x30 sek interval', 'name - StringAttribute : 9 x ~30 sek interval',
            'name - StringAttribute : Evening Run', 'name - StringAttribute : Løb med phillip',
            'name - StringAttribute : Morgen', 'name - StringAttribute : Morning Run',
            'photo_count - IntAttribute : 0', 'pr_count - IntAttribute : 0', 'pr_count - IntAttribute : 5',
            'private - BoolAttribute : False', 'private - BoolAttribute : True',
            'resource_state - IntAttribute : 1', 'resource_state - IntAttribute : 2',
            ...
            'start_latitude - FloatAttribute : 55.694375', 'start_latitude - FloatAttribute : 55.727547',
            'start_latitude - FloatAttribute : 55.727747', 'start_latitude - FloatAttribute : 55.727841',
            'start_latitude - FloatAttribute : 55.72792', 'start_latitude - FloatAttribute : 55.727978',
            'start_latitude - FloatAttribute : 55.823333', 'start_latlng - FloatAttribute : 12.57413',
            'start_latlng - FloatAttribute : 12.574154', 'start_latlng - FloatAttribute : 12.574233',
            'start_latlng - FloatAttribute : 12.574337', 'start_latlng - FloatAttribute : 12.574341',
            'start_latlng - FloatAttribute : 12.586909', 'start_latlng - FloatAttribute : 55.694375',
            'start_latlng - FloatAttribute : 55.727547', 'start_latlng - FloatAttribute : 55.727747',
            'start_latlng - FloatAttribute : 55.727841', 'start_latlng - FloatAttribute : 55.72792',
            'start_latlng - FloatAttribute : 55.727978', 'start_latlng - FloatAttribute : 55.823333',
            'start_latlng - FloatAttribute : 9.105255', 'start_latlng - Node',
            'start_longitude - FloatAttribute : 12.57413', 'start_longitude - FloatAttribute : 12.574154',
            'start_longitude - FloatAttribute : 12.574233', 'start_longitude - FloatAttribute : 12.574337',
            'start_longitude - FloatAttribute : 12.574341', 'start_longitude - FloatAttribute : 12.586909',
            ...
            'total_elevation_gain - FloatAttribute : 11.1', 'total_elevation_gain - FloatAttribute : 13.2',
            'total_elevation_gain - FloatAttribute : 14.0', 'total_elevation_gain - FloatAttribute : 22.0',
            'total_elevation_gain - FloatAttribute : 27.3', 'total_elevation_gain - FloatAttribute : 27.7',
