...
from MetaDataApi.metadata.models.meta.SchemaNode import SchemaNode
...
class SchemaAttribute(BaseMeta):
    ...
    object = models.ForeignKey(SchemaNode, related_name='attributes', on_delete=models.CASCADE)
