...
class rdfService:
    ...
    def create_graph(self, rdf_url):
        ...
        if rdf_url in self.selfhosted:
            ...
            # make sure we are comparing with the right one,
            # else convert to self hosted
            # namespace = self.selfhosted[namespace] if
            # namespace in self.selfhosted else namespace
