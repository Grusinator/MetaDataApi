...
class test_rdfDataProviders(TransactionTestCase):
    ...
    def test_create_dataprovider(self):
        from MetaDataApi.metadata.rdf_models.meta_data_api.data_providers import RdfDataProviders

        LoadTestData.init_meta_data_api()
        RdfDataProviders.create_data_provider()
    ...
    def test_create_datadump(self):
        ...
        provider = RdfDataProviders.create_data_provider()
        RdfDataProviders.create_data_dump(provider, datetime(1, 1, 1, 1, 1, 1), file)
