...
from dataproviders.admin import DataFetchAdmin
from dataproviders.models.DataFetch import data_dump_save_methods, DataFetch
...
def build_models_and_load_data_chained(data_dump: DataFetch):
...
def build_models(data_dump: DataFetch):
...
def connect_tasks():
    ...
    DataFetchAdmin.add_action_from_single_arg_method(build_models_and_load_data_chained)
